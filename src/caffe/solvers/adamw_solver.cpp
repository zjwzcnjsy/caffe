...
template <typename Dtype>
void AdamWSolver<Dtype>::ComputeUpdateValue(int param_id, Dtype rate) {
  ...
  case Caffe::GPU: {
#ifndef CPU_ONLY
    adamw_update_gpu(N, net_params[param_id]->mutable_cpu_data(), net_params[param_id]->mutable_gpu_diff(),
...
INSTANTIATE_CLASS(AdamWSolver);
REGISTER_SOLVER_CLASS(AdamW);
