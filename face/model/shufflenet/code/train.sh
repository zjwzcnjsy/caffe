...
$CAFFE_HOME/build/tools/caffe train -solver code/shufflenet_1x_g3_ms_step2_solver.prototxt -weights result/shufflenet_1x_g3_ms_step1_iter_30000.caffemodel -gpu ${GPU_ID}
