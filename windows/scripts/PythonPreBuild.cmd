...
if not exist "%OUTPUT_DIR%\pycaffe\caffe\utils" mkdir "%OUTPUT_DIR%\pycaffe\caffe\utils"
if not exist "%OUTPUT_DIR%\pycaffe\caffe\imagenet" mkdir "%OUTPUT_DIR%\pycaffe\caffe\imagenet"
if not exist "%OUTPUT_DIR%\pycaffe\caffe\model" mkdir "%OUTPUT_DIR%\pycaffe\caffe\model"
